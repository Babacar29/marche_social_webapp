...
class _RecentUsersState extends State<RecentUsers> {
          ...
          Container(
            ...
            child: DataTable(
              ...
              columns: const[
                ...
                DataColumn(
                  label: Text("Code Postal Vendeur", textAlign: TextAlign.center,),
                ),
                DataColumn(
                  label: Text("Adresse Acheteur", textAlign: TextAlign.center,),
                ),
                DataColumn(
                  label: Text("Code Postal Acheteur", textAlign: TextAlign.center,),
                ),
                DataColumn(
                  label: Text("Livraison en\nboite au lettre", textAlign: TextAlign.center,),
                ),
                DataColumn(
                  label: Text("Coùt de la livraison", textAlign: TextAlign.center,),
                ),
                DataColumn(
                  label: Text("Coùt Total du produit", textAlign: TextAlign.center,),
                ),
                DataColumn(
              ...
              rows: List.generate(
                orders.length,
                (index) => recentUserDataRow(orders[index], context, sController, buController),
              ),
            ),
          ),
  ...
  DataRow recentUserDataRow(OrderModel orderInfo, BuildContext context, SellerProfileController sController, BuyerProfileController buyerController) {
