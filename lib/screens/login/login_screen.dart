...
import 'package:marche_social_webapp/core/widgets/app_button_widget.dart';
import 'package:marche_social_webapp/core/widgets/input_widget.dart';
import 'package:marche_social_webapp/screens/home/home_screen.dart';
import 'package:marche_social_webapp/screens/login/components/slider_widget.dart';
        ...
        child: Column(
          ...
          children: [
            InputWidget(
              ...
              hintText: "Enter E-mail",
              kController: authController.loginEmail,
              // prefixIcon: FlutterIcons.chevron_left_fea,
            ),
            SizedBox(height: 8.0),
            InputWidget(
              ...
              onChanged: (String? value) {},
              validator: (String? value) {},
              kController: authController.loginPassword,
            ),
            SizedBox(height: 24.0),
            AppButton(
              type: ButtonType.PRIMARY,
              text: "Sign In",
              onPressed: () async{
                await authController.validateAndLoginWithEmail(context);
                /*Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => HomeScreen()),
                );*/
